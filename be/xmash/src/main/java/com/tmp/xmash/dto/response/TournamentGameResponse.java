...
public record TournamentGameResponse (
        ...
        int round,
        @Schema(name = "homeTeamId", example = "1", description = "현재 토너먼트의 홈팀 id", nullable = true)
        Long homeTeamId,
        @Schema(name = "awayTeamId", example = "2", description = "현재 토너먼트의 어웨이팀 id", nullable = true)
        Long awayTeamId,
        ...
        @Schema(name = "winnerId", example = "2", description = "setGameResultResponses 따른 승리자 id", nullable = true)
        Long winnerId
)  {
